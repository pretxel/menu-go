                ...
                <Row align="middle" justify="space-between">
                    <Col xl={10} lg={14} md={16} span={24}>
                        ...
                        <p className="h5 hp-font-weight-400 hp-text-color-black-80 hp-text-color-dark-30 hp-mb-48 hp-pr-96">
                            ...
                            hendrerit omittantur mel, es vidit Ius te omittantur
                            meles vidit Ius te altera essent incorrupte.
                        </p>
                            ...
                            <Col span={24}>
                                <Row align="middle">
                                    ...
                                    <Col className="hp-ml-16">
                                        <h3 className="hp-font-weight-500 hp-text-color-black-80 hp-text-color-dark-30 hp-mb-0">
                            ...
                            <Col span={24}>
                                <Row align="middle">
                                    ...
                                    <Col className="hp-ml-16">
                                        <Row align="middle">
                                            <Col>
                                                <h3 className="hp-font-weight-500 hp-text-color-black-80 hp-text-color-dark-30 hp-mb-0 hp-mr-24">
                                                    Unlimited storage
                                                </h3>
                                            </Col>

                                            <Col>
                                                <span className="hp-px-8 hp-py-6 hp-bg-warning-1 hp-border-radius hp-caption hp-font-weight-400 hp-text-color-black-100">
                                                    PRO
                                                </span>
                                            </Col>
                                        </Row>
