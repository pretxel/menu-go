    ...
    return (
        <section className="hp-landing-features hp-pt-24">
            <Row align="middle" justify="center">
                ...
                >
                    <h2 className="h1 hp-mb-32">Built With Amazing Features</h2>
                    ...
                    <p className="h5 hp-font-weight-400 hp-text-color-black-80 hp-text-color-dark-30">
                        ...
                        operating systems with minor changes, and yet always.
                    </p>
                </Col>

                <Col
                    span={24}
                    className="hp-px-16 hp-text-center hp-mt-sm-32 hp-mt-64"
                >
