...
import peopleEmoji1 from '../../src/assets/images/pages/landing/people-emoji-1.png'
import peopleEmoji2 from '../../src/assets/images/pages/landing/people-emoji-2.png'
import peopleEmoji3 from '../../src/assets/images/pages/landing/people-emoji-3.png'
import peopleEmoji4 from '../../src/assets/images/pages/landing/people-emoji-4.png'
import peopleEmoji5 from '../../src/assets/images/pages/landing/people-emoji-5.png'
import peopleEmoji6 from '../../src/assets/images/pages/landing/people-emoji-6.png'
            ...
            <div className="hp-landing-people-item hp-position-relative hp-border-radius hp-bg-black-0 hp-bg-dark-90 hp-p-sm-16 hp-p-24">
                ...
                <Row align="middle">
                    ...
                    <Col className="hp-landing-people-item-title">
                        <span className="hp-d-block h5 hp-font-weight-400">
                            {item.name}
                        </span>
                ...
                <Row justify="center">
                    ...
                    >
                        ...
                        <p className="h5 hp-font-weight-400 hp-text-color-black-80 hp-text-color-dark-30 hp-mt-sm-0 hp-mt-32 hp-mb-0">
                            These companies release their own versions of the
                            operating systems with minor changes, and yet
                            always.
                        </p>
                    </Col>
