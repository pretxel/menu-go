...
Every published catalog gets one public, login-free menu page at `/r/<slug>` — the same URL encoded in its QR code — plus a post-publish success screen with share artifacts (QR image, copy-link, download-QR).
